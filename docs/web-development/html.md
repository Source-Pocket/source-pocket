...
- [azkod HTML dersleri](https://www.azkod.com/html "azkod HTML dersleri")
- [Turkcell | Geleceği Yazanlar](https://gelecegiyazanlar.turkcell.com.tr/konu/egitim/101-html/htmle-giris "Turkcell | Geleceği Yazanlar")
- [🎥 HTML Eğitim Serisi (Kablosuz kedi) 🎥](https://www.youtube.com/playlist?list=PL_f2F0Oyaj4-Qro_C0ixzMWpCiogfXxKE "HTML Eğitim Serisi (Kablosuz kedi)")
...
- [A list of everything that *could* go in the head of your document | turkish](https://github.com/mkg0/HEAD "A list of everything that *could* go in the <head> of your document | turkish")
