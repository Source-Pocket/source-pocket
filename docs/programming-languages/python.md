...
- [Python Programlamaya Giriş | veridefteri](http://www.veridefteri.com/category/python-giris/ "Python Programlamaya Giriş")
- [Erdinç Uzun](https://erdincuzun.com/python/01-python/ "Erdinç Uzun")
- [Python Türkçe Dökümanlar | Dincer Aydın ](http://www.dinceraydin.com/python/tut/tut.html "Python Türkçe Dökümanlar")
- [🎥 Yeni Başlayanlar için Python Eğitim Kursu | freeCodeCamp 🎥](https://youtu.be/rfscVS0vtbw "Yeni Başlayanlar için Python Eğitim Kursu")
